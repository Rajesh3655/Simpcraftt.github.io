...
export default function HomePage() {
  return (
    <CommerceShell>
      <section className="relative min-h-[calc(100svh-64px)] overflow-hidden px-4 py-6 md:min-h-[calc(100vh-76px)] md:px-5 md:py-10">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(5,6,7,0.78),rgba(5,6,7,0.54),rgba(5,6,7,0.88))] md:bg-[linear-gradient(90deg,rgba(5,6,7,0.92),rgba(5,6,7,0.62),rgba(5,6,7,0.24))]" />
          <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#f6f7f4] to-transparent dark:from-[#050607]" />
        </div>

        <div className="relative z-10 mx-auto flex min-h-[calc(100svh-128px)] max-w-7xl items-end pb-10 md:min-h-[calc(100vh-140px)] md:items-center md:pb-0">
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7 }}
            className="max-w-3xl py-10 text-white md:py-20"
          >
            <p className="mb-4 text-[10px] font-black uppercase tracking-[0.18em] text-emerald-200 md:mb-5 md:text-xs">
              Marketplace-first ecommerce platform
            </p>
            <h1 className="luxury-heading text-5xl md:text-7xl lg:text-8xl">
              Simpcraftt
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-7 text-white/78 md:mt-7 md:text-lg md:leading-8">
      ...
      <section className="px-4 py-10 md:px-5 md:py-16">
        <div className="mx-auto flex max-w-7xl gap-3 overflow-x-auto pb-2 md:grid md:grid-cols-4 md:overflow-visible md:pb-0">
          {categories.map((category, index) => {
            ...
            return (
              <a
                ...
                className="min-w-[78vw] rounded-2xl border border-black/10 bg-white/78 p-5 shadow-[0_20px_60px_rgba(17,23,20,0.08)] transition hover:-translate-y-1 hover:bg-white dark:border-white/10 dark:bg-white/[0.045] dark:hover:bg-white/10 sm:min-w-[42vw] md:min-w-0 md:rounded-lg md:p-6"
              >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-6 flex flex-col justify-between gap-5 md:mb-8 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="luxury-title text-3xl md:text-6xl">Built to be discovered, bought, and supported.</h2>
            </div>
      ...
      <section className="px-4 py-10 md:px-5 md:py-16">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <h2 className="luxury-title text-3xl md:text-6xl">Marketplace now. Direct ecommerce next.</h2>
          ...
          <div className="grid gap-3 sm:grid-cols-2 md:gap-4">
            {[
              ...
              <div key={title} className="rounded-2xl border border-black/10 bg-white/74 p-5 dark:border-white/10 dark:bg-white/[0.045] md:rounded-lg md:p-6">
      ...
      <section className="px-4 py-10 md:px-5 md:py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-8">
            ...
            <h2 className="luxury-title text-3xl md:text-6xl">Product families for real workflows.</h2>
          </div>
          <CollectionGrid />
        </div>
      </section>
      ...
      <section className="px-4 py-10 md:px-5 md:py-16">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.8fr_1fr]">
          <div>
            ...
            <h2 className="luxury-title text-3xl md:text-6xl">Care is part of the product.</h2>
            <p className="mt-6 leading-8 text-black/64 dark:text-white/64">
