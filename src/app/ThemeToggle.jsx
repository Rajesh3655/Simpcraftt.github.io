...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`relative w-16 h-8 md:w-20 md:h-10 flex items-center ${isDark ? "justify-end" : "justify-start"} rounded-full p-1 transition-colors duration-500 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500/50 ${
        isDark
    ...
    >
      ...
      <motion.div
        layout
        className={`relative z-10 w-6 h-6 md:w-8 md:h-8 flex items-center justify-center rounded-full transition-shadow duration-300 ${
          isDark
