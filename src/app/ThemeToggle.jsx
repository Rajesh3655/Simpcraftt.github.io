...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`relative w-20 h-10 flex items-center rounded-full p-1 transition-colors duration-500 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500/50 ${
        isDark
    ...
    >
      ...
      <motion.div
        className={`relative z-10 w-8 h-8 flex items-center justify-center rounded-full transition-shadow duration-300 ${
          isDark
      ...
      >
        ...
        <motion.div
          ...
          className="absolute"
        >
          <Moon className="w-4 h-4 text-blue-400 drop-shadow-[0_0_8px_rgba(96,165,250,0.8)]" />
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute"
        >
          <Sun className="w-4 h-4 text-orange-500 drop-shadow-[0_0_8px_rgba(249,115,22,0.6)]" />
        </motion.div>
      </motion.div>
    </button>
  );
