...
const schema = new mongoose.Schema(
  {
    ...
    claimStatus: { type: String, trim: true, maxlength: 80, index: true },
    rejectionReason: { type: String, trim: true, maxlength: 1000 },
    adminNotes: { type: String, trim: true, maxlength: 2000 },
    notes: { type: String, trim: true, maxlength: 2000 },
    returnShipment: {
      courierName: { type: String, trim: true, maxlength: 120 },
      trackingId: { type: String, trim: true, maxlength: 120 },
      notes: { type: String, trim: true, maxlength: 500 },
      shippedAt: { type: Date },
    },
    serviceCenterReceivedAt: { type: Date },
    inspectionStatus: { type: String, trim: true, maxlength: 120 },
    replacementShipment: {
      courierName: { type: String, trim: true, maxlength: 120 },
      trackingId: { type: String, trim: true, maxlength: 120 },
